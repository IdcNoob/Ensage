        ...
        public static Dictionary<string, string> Heroes = new Dictionary<string, string>
                                                              {
                                                                  ...
                                                                  {
                                                                      "Night Stalker, Balanar, NS",
                                                                      "npc_dota_hero_night_stalker"
                                                                  },
                                                                  {
                                                                      "Nyx Assassin​, Nerubian",
                                                                  ...
                                                                  {
                                                                      "Outworld Devourer, Obsidian Destroyer, OD​",
                                                                      "npc_dota_hero_obsidian_destroyer"
                                                                  },
                                                                  {
                                                                      "Phantom Assassin, Mortred, PA​",
                                                                  ...
                                                                  {
                                                                      "Windranger​, Windrunner, WR",
                                                                      "npc_dota_hero_windrunner"
                                                                  },
                                                                  { "Winter Wyvern, WW​​", "npc_dota_hero_winter_wyvern" },
                                                                  {
                                                                      "Wraith King​, Leoric, Skeleton King WK",
