        ...
        public CampsInfo(Team heroTeam)
        {
            if (heroTeam == Team.Radiant)
            {
                    ...
                    new Camp
                        {
                            ...
                            WaitPosition = new Vector3(-1925, -4062, 256), Id = 1, StackTime = 54.5, Team = Team.Radiant,
                    ...
                    new Camp
                        {
                            ...
                            Id = 3, StackTime = 54.5, Team = Team.Radiant, Ancients = false, Name = "Medium Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 4, StackTime = 53.1, Team = Team.Radiant, Ancients = false, Name = "Hard Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                ...
                this.camps.Add(
                    new Camp
                        {
                            OverlayPosition = new Vector3(-3000, 300, 384), CampPosition = new Vector3(-2865, -107, 384),
            ...
            else if (heroTeam == Team.Dire)
            {
                ...
                this.camps.Add(
                    new Camp
                        {
                            OverlayPosition = new Vector3(-291, 3200, 384), CampPosition = new Vector3(-396, 3859, 384),
                            StackPosition = new Vector3(-611, 5520, 256), WaitPosition = new Vector3(-499, 4027, 384),
                            Id = 9, StackTime = 54.5, Team = Team.Dire, Ancients = false, Name = "Medium Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 10, StackTime = 53, Team = Team.Dire, Ancients = false, Name = "Medium Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 11, StackTime = 54, Team = Team.Dire, Ancients = false, Name = "Easy Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 12, StackTime = 53, Team = Team.Dire, Ancients = false, Name = "Top Hard Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 13, StackTime = 54, Team = Team.Dire, Ancients = true, Name = "Ancients Camp"
                        });
                this.camps.Add(
                    new Camp
                        {
                            ...
                            Id = 14, StackTime = 54, Team = Team.Dire, Ancients = false, Name = "Secret Camp"
                        });
            }
        }
