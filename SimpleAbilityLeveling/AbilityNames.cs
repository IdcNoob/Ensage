namespace SimpleAbilityLeveling
{
    ...
    internal class AbilityNames
    {
        public Dictionary<string, string> Names { get; } = new Dictionary<string, string>
        {
            ...
            { "Call of the Wild: Hawk", "beastmaster_call_of_the_wild_hawk" },
            { "Call of the Wild: Boar", "beastmaster_call_of_the_wild_boar" },
            ...
            { "Adaptive Strike", "morphling_adaptive_strike" },
            { "Morph (Agility Gain)", "morphling_morph_agi" },
            { "Replicate", "morphling_replicate" },
            ...
            { "Toss", "tiny_toss" },
            { "Craggy Exterior", "tiny_craggy_exterior" },
            { "Grow", "tiny_grow" },
